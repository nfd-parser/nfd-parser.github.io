  ...
  themeConfig: {
    ...
    nav: [
      ...
      { text: '示例', link: '/examples' },
      {
        text: '解析器开发',
        items: [
          { text: '解析器概述', link: '/guide/parser/' },
          { text: 'JS 解析器开发', link: '/guide/parser/javascript-parser' },
          { text: '自定义解析器', link: '/guide/parser/custom-parser-guide' },
          { text: '客户端链接生成', link: '/guide/parser/client-link-generator' }
        ]
      },
      { 
        text: '更多',
      ...
      '/guide/parser/': [
        {
          ...
          items: [
            { text: '解析器概述', link: '/guide/parser/' },
            { text: 'JS 解析器开发指南', link: '/guide/parser/javascript-parser' },
            { text: '自定义解析器快速开始', link: '/guide/parser/custom-parser-quickstart' },
            { text: '自定义解析器扩展指南', link: '/guide/parser/custom-parser-guide' },
            { text: 'API 使用指南', link: '/guide/parser/api-usage' },
            { text: '客户端链接生成器', link: '/guide/parser/client-link-generator' }
          ]
        }
      ],
      '/guide/': [
